...
public class DocumentDAO {
    ...
    public void deleteDocuments(int docID, int folderID, String username) throws SQLException {
    	String querry1 = "Delete From document Where ID = ? And Author = ?";
    	String querry2 =  "Delete From document Where Folder = ? And Author = ?";
    	int result = 0;
    	PreparedStatement statement = null;
    	if(docID!=-1) {
    		try {
    		    statement = connection.prepareStatement(querry1);
    		    statement.setInt(1, docID);
    		    statement.setString(2, username);
    		    result = statement.executeUpdate();
    		}catch(SQLException e) {
    		...
    		try {
    		    statement = connection.prepareStatement(querry2);
    		    statement.setInt(1, folderID);
    		    statement.setString(2, username);
    		    result = statement.executeUpdate();
    		}catch(SQLException e) {
